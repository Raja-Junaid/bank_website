...
const Stats = () => {
  return (
    <div id="statistics" className="max-container grid grid-cols-1 sm:grid-cols-3 gap-y-8 lg:gap-y-0 lg:flex lg:justify-between py-8 lg:py-11 xl:py-12 border-t border-b border-gray-400">
      {stats.map((stat) => (
