    ...
    <div className="relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 lg:gap-x-12  gap-y-10 lg:gap-y-20 justify-center items-center">
        {pricing.map((price, index) => (
          <div key={price.id} className={`${index === pricing.length - 2 ? 'pricingCardBg' : 'bg-white'} flex flex-col justify-center items-center gap-y-8 w-[300px] sm:w-[350px] 2xl:w-[360px] mx-auto border py-10 border-darkTeal rounded-xl`}>
            <div>
